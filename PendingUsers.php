<?php
   ...
   include('conn.php');
$query="select * from pendingregistration";
        ...
        {    
            If ($color==1){
                ...
                foreach ($rows as $data){
                    ...
                    echo "<td >"."<a href = \"call3.php?email=".$rows['email']."\">"."<button> Confirm Registration </button>". "</td>";
                    echo "<td >"."<a href = \"call2.php?email=".$rows['email']."\">"."<button> Delete Registration </button>". "</td>";
                $color=2;
            }
            $color=1;
        }
